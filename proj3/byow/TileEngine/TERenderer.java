...
//                "Character Select (WIP) (S)",
    ...
    public char renderHelp() {
        ...
        String[] lines = {
                ...
                "",
                "WASD to move, or click on a floor tile to move there. The robots act every time",
                "you move one square, so be careful! They will chase you down if they see you.",
                "Fortunately, robots do not see well as well in the dark as you. When a robot",
